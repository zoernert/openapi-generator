...
<dependency>
  ...
  <artifactId>petstore-resteasy-openapi3</artifactId>
...
```groovy
compile "org.openapitools:petstore-resteasy-openapi3:1.0.0"
```
...
- `target/petstore-resteasy-openapi3-1.0.0.jar`
- `target/lib/*.jar`
