...
public class FakeApi {
    ...
    public FakeHealthGetOper fakeHealthGet() {
        return new FakeHealthGetOper(createReqSpec());
    }

    @ApiOperation(value = "test http signature authentication",
            notes = "",
            nickname = "fakeHttpSignatureTest",
            tags = { "fake" })
    @ApiResponses(value = { 
            @ApiResponse(code = 200, message = "The instance started successfully")  })
    public FakeHttpSignatureTestOper fakeHttpSignatureTest() {
        return new FakeHttpSignatureTestOper(createReqSpec());
    }
    ...
    @ApiOperation(value = "",
            ...
            tags = { "fake" })
    @ApiResponses(value = { 
            @ApiResponse(code = 200, message = "Output enum (int)")  })
    public FakePropertyEnumIntegerSerializeOper fakePropertyEnumIntegerSerialize() {
     ...
     */
    public static class FakeHealthGetOper implements Oper {

        public static final Method REQ_METHOD = GET;
        public static final String REQ_URI = "/fake/health";

        private RequestSpecBuilder reqSpec;
        private ResponseSpecBuilder respSpec;

        public FakeHealthGetOper(RequestSpecBuilder reqSpec) {
         ...
         * @return HealthCheckResult
         */
        public HealthCheckResult executeAs(Function<Response, Response> handler) {
            Type type = new TypeToken<HealthCheckResult>(){}.getType();
         ...
         * @return operation
         */
        public FakeHealthGetOper reqSpec(Consumer<RequestSpecBuilder> reqSpecCustomizer) {
            reqSpecCustomizer.accept(reqSpec);
            return this;
        }
         ...
         * @return operation
         */
        public FakeHealthGetOper respSpec(Consumer<ResponseSpecBuilder> respSpecCustomizer) {
     ...
     * @see #query1Query query parameter (optional)
     * @see #header1Header header parameter (optional)
     */
    public static class FakeHttpSignatureTestOper implements Oper {

        public static final Method REQ_METHOD = GET;
        public static final String REQ_URI = "/fake/http-signature-test";

        private RequestSpecBuilder reqSpec;
        private ResponseSpecBuilder respSpec;

        public FakeHttpSignatureTestOper(RequestSpecBuilder reqSpec) {
            this.reqSpec = reqSpec;
         ...
         * @return operation
         */
        public FakeHttpSignatureTestOper body(Pet pet) {
            reqSpec.setBody(pet);
            return this;
        }

        public static final String HEADER1_HEADER = "header_1";

        /**
         * @param header1 (String) header parameter (optional)
         * @return operation
         */
        public FakeHttpSignatureTestOper header1Header(String header1) {
            reqSpec.addHeader(HEADER1_HEADER, header1);
            return this;
        }

        public static final String QUERY1_QUERY = "query_1";

        /**
         * @param query1 (String) query parameter (optional)
         * @return operation
         */
        public FakeHttpSignatureTestOper query1Query(Object... query1) {
            reqSpec.addQueryParam(QUERY1_QUERY, query1);
            return this;
        }
         ...
         * @return operation
         */
        public FakeHttpSignatureTestOper reqSpec(Consumer<RequestSpecBuilder> reqSpecCustomizer) {
            reqSpecCustomizer.accept(reqSpec);
            return this;
        }
         ...
         * @return operation
         */
        public FakeHttpSignatureTestOper respSpec(Consumer<ResponseSpecBuilder> respSpecCustomizer) {
            respSpecCustomizer.accept(respSpec);
            return this;
        }
    }
     ...
     *
     * @see #body Input enum (int) as post body (required)
     * return OuterObjectWithEnumProperty
     */
    public static class FakePropertyEnumIntegerSerializeOper implements Oper {

        public static final Method REQ_METHOD = POST;
        public static final String REQ_URI = "/fake/property/enum-int";

        private RequestSpecBuilder reqSpec;
        private ResponseSpecBuilder respSpec;

        public FakePropertyEnumIntegerSerializeOper(RequestSpecBuilder reqSpec) {
            this.reqSpec = reqSpec;
            reqSpec.setContentType("application/json");
            reqSpec.setAccept("*/*");
            this.respSpec = new ResponseSpecBuilder();
         ...
         * @return OuterObjectWithEnumProperty
         */
        public OuterObjectWithEnumProperty executeAs(Function<Response, Response> handler) {
            Type type = new TypeToken<OuterObjectWithEnumProperty>(){}.getType();
            return execute(handler).as(type);
        }

         /**
         * @param outerObjectWithEnumProperty (OuterObjectWithEnumProperty) Input enum (int) as post body (required)
         * @return operation
         */
        public FakePropertyEnumIntegerSerializeOper body(OuterObjectWithEnumProperty outerObjectWithEnumProperty) {
            reqSpec.setBody(outerObjectWithEnumProperty);
            return this;
        }
         ...
         * @return operation
         */
        public FakePropertyEnumIntegerSerializeOper reqSpec(Consumer<RequestSpecBuilder> reqSpecCustomizer) {
            reqSpecCustomizer.accept(reqSpec);
            return this;
        }
         ...
         * @return operation
         */
        public FakePropertyEnumIntegerSerializeOper respSpec(Consumer<ResponseSpecBuilder> respSpecCustomizer) {
            respSpecCustomizer.accept(respSpec);
            return this;
        }
    }
