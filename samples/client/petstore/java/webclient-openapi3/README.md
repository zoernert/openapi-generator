...
<dependency>
  ...
  <artifactId>petstore-webclient-openapi3</artifactId>
...
```groovy
compile "org.openapitools:petstore-webclient-openapi3:1.0.0"
```
...
- `target/petstore-webclient-openapi3-1.0.0.jar`
- `target/lib/*.jar`
