...
open class AnotherFakeAPI {
     ...
     */
    open class func call123testSpecialTags(client: Client, apiResponseQueue: DispatchQueue = PetstoreClientAPI.apiResponseQueue, completion: @escaping ((_ data: Client?, _ error: Error?) -> Void)) {
        call123testSpecialTagsWithRequestBuilder(client: client).execute(apiResponseQueue) { result -> Void in
            switch result {
